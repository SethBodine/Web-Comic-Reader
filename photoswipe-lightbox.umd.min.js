(() => {
  ...
  // node_modules/libarchive-wasm/dist/ArchiveReaderEntry.js
  var require_ArchiveReaderEntry = __commonJS({
    "node_modules/libarchive-wasm/dist/ArchiveReaderEntry.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.ArchiveReaderEntry = void 0;
      var ArchiveReaderEntry2 = (
        /** @class */
        (function() {
          function ArchiveReaderEntry3(reader, ptr) {
            this.reader = reader;
            this.pointer = ptr;
            this.readCalled = false;
          }
          ArchiveReaderEntry3.prototype.free = function() {
            this.skipData();
            this.reader = null;
            this.pointer = null;
          };
          ArchiveReaderEntry3.prototype.readData = function() {
            if (this.readCalled)
          ...
          ArchiveReaderEntry3.prototype.skipData = function() {
            if (this.readCalled)
              return;
            this.readCalled = true;
            this.reader.skipData();
          };
          ArchiveReaderEntry3.prototype.getFiletype = function() {
            return this.reader.getEntryFiletype(this.pointer);
          };
          ArchiveReaderEntry3.prototype.getPathname = function() {
            return this.reader.getEntryPathname(this.pointer);
          };
          ArchiveReaderEntry3.prototype.getSize = function() {
            return this.reader.getEntrySize(this.pointer);
          };
          ArchiveReaderEntry3.prototype.getAccessTime = function() {
            return this.reader.getEntryAccessTime(this.pointer);
          };
          ArchiveReaderEntry3.prototype.getBirthTime = function() {
            return this.reader.getEntryBirthTime(this.pointer);
          };
          ArchiveReaderEntry3.prototype.getCreationTime = function() {
            return this.reader.getEntryCreationTime(this.pointer);
          };
          ArchiveReaderEntry3.prototype.getModificationTime = function() {
            return this.reader.getEntryModificationTime(this.pointer);
          };
          ArchiveReaderEntry3.prototype.isEncrypted = function() {
            return this.reader.isEntryEncrypted(this.pointer);
          };
          ArchiveReaderEntry3.prototype.getSymlinkTarget = function() {
            return this.reader.getSymlinkTarget(this.pointer);
          };
          ArchiveReaderEntry3.prototype.getHardlinkTarget = function() {
            return this.reader.getHardlinkTarget(this.pointer);
          };
          return ArchiveReaderEntry3;
        })()
      );
      exports.ArchiveReaderEntry = ArchiveReaderEntry2;
    }
  });

  // node_modules/libarchive-wasm/dist/ArchiveReader.js
  var require_ArchiveReader = __commonJS({
    "node_modules/libarchive-wasm/dist/ArchiveReader.js"(exports) {
      "use strict";
      ...
      var ArchiveReaderEntry_1 = require_ArchiveReaderEntry();
      ...
      var ArchiveReader2 = (
        /** @class */
        (function() {
          function ArchiveReader3(libarchive, data, passphrase) {
          ...
          ArchiveReader3.prototype.free = function() {
          ...
          ArchiveReader3.prototype.hasEncryptedData = function() {
            var code = this.libarchive.read_has_encrypted_entries(this.archive);
            return code < 0 ? null : !!code;
          };
          ArchiveReader3.prototype.readData = function(size) {
          ...
          ArchiveReader3.prototype.skipData = function() {
            this.libarchive.read_data_skip(this.archive);
          };
          ArchiveReader3.prototype.nextEntryPointer = function() {
            return this.libarchive.read_next_entry(this.archive);
          };
          ArchiveReader3.prototype.getEntryFiletype = function(ptr) {
            var fileType = String(this.libarchive.entry_filetype(ptr));
            return fileType in ArchiveReader3.FileTypes ? ArchiveReader3.FileTypes[fileType] : "Invalid";
          };
          ArchiveReader3.prototype.getEntryPathname = function(ptr) {
            return this.libarchive.entry_pathname(ptr);
          };
          ArchiveReader3.prototype.getEntrySize = function(ptr) {
            return this.libarchive.entry_size(ptr);
          };
          ArchiveReader3.prototype.getEntryAccessTime = function(ptr) {
            return toTimeFromTimeT(this.libarchive.entry_atime(ptr));
          };
          ArchiveReader3.prototype.getEntryBirthTime = function(ptr) {
            return toTimeFromTimeT(this.libarchive.entry_birthtime(ptr));
          };
          ArchiveReader3.prototype.getEntryCreationTime = function(ptr) {
            return toTimeFromTimeT(this.libarchive.entry_ctime(ptr));
          };
          ArchiveReader3.prototype.getEntryModificationTime = function(ptr) {
            return toTimeFromTimeT(this.libarchive.entry_mtime(ptr));
          };
          ArchiveReader3.prototype.isEntryEncrypted = function(ptr) {
            return !!this.libarchive.entry_is_encrypted(ptr);
          };
          ArchiveReader3.prototype.getSymlinkTarget = function(ptr) {
            return this.libarchive.entry_symlink(ptr);
          };
          ArchiveReader3.prototype.getHardlinkTarget = function(ptr) {
            return this.libarchive.entry_hardlink(ptr);
          };
          ArchiveReader3.prototype.nextEntry = function() {
            var entryPtr = this.nextEntryPointer();
            if (entryPtr === 0)
              return null;
            return new ArchiveReaderEntry_1.ArchiveReaderEntry(this, entryPtr);
          };
          ArchiveReader3.prototype.forEach = function(fn) {
            for (; ; ) {
          ...
          ArchiveReader3.prototype.entries = function() {
            var entry;
          ...
          ArchiveReader3.FileTypes = (_a = {}, _a["".concat(61440)] = "Mount", _a["".concat(32768)] = "File", _a["".concat(40960)] = "SymbolicLink", _a["".concat(49152)] = "Socket", _a["".concat(8192)] = "CharacterDevice", _a["".concat(24576)] = "BlockDevice", _a["".concat(16384)] = "Directory", _a["".concat(4096)] = "NamedPipe", _a);
          return ArchiveReader3;
        })()
      );
      exports.ArchiveReader = ArchiveReader2;
    }
  });

  // stubs/fs.js
  var require_fs = __commonJS({
    "stubs/fs.js"(exports, module) {
      module.exports = {};
    }
  });
  ...
  var require_crypto = __commonJS({
    "stubs/crypto.js"(exports, module) {
      module.exports = {};
    }
  });

  // node_modules/libarchive-wasm/dist/libarchive.js
  var require_libarchive = __commonJS({
    "node_modules/libarchive-wasm/dist/libarchive.js"(exports, module) {
      "use strict";
      ...
      var libarchive = (function() {
        var _a;
        var _scriptName = typeof document != "undefined" ? (_a = document.currentScript) === null || _a === void 0 ? void 0 : _a.src : void 0;
        ...
        return (function() {
          return __awaiter(this, arguments, void 0, function(moduleArg) {
            ...
            function getWasmBinary(binaryFile) {
              return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_b) {
                  switch (_b.label) {
                    case 0:
                      if (!!wasmBinary) return [3, 4];
                      _b.label = 1;
                    case 1:
                      _b.trys.push([1, 3, , 4]);
                      return [4, readAsync(binaryFile)];
                    case 2:
                      response = _b.sent();
                      return [2, new Uint8Array(response)];
                    case 3:
                      _a2 = _b.sent();
                      return [3, 4];
                    case 4:
                      return [2, getBinarySync(binaryFile)];
                  }
                });
              });
            }
            function instantiateArrayBuffer(binaryFile, imports) {
              return __awaiter(this, void 0, void 0, function() {
                var binary, instance, reason_1;
                return __generator(this, function(_a2) {
                  switch (_a2.label) {
                    case 0:
                      _a2.trys.push([0, 3, , 4]);
                      return [4, getWasmBinary(binaryFile)];
                    case 1:
                      binary = _a2.sent();
                      return [4, WebAssembly.instantiate(binary, imports)];
                    case 2:
                      instance = _a2.sent();
                      return [2, instance];
                    case 3:
            ...
            function instantiateAsync(binary, binaryFile, imports) {
              return __awaiter(this, void 0, void 0, function() {
                var response, instantiationResult, reason_2;
                return __generator(this, function(_a2) {
                  switch (_a2.label) {
                    case 0:
                      if (!(!binary && typeof WebAssembly.instantiateStreaming == "function" && !isFileURI(binaryFile) && !ENVIRONMENT_IS_NODE)) return [3, 4];
                      _a2.label = 1;
                    case 1:
                      _a2.trys.push([1, 3, , 4]);
                      response = fetch(binaryFile, { credentials: "same-origin" });
                      return [4, WebAssembly.instantiateStreaming(response, imports)];
                    case 2:
                      instantiationResult = _a2.sent();
                      return [2, instantiationResult];
                    case 3:
                      reason_2 = _a2.sent();
                      ...
                      return [3, 4];
                    case 4:
                      return [2, instantiateArrayBuffer(binaryFile, imports)];
                  }
                });
              });
            }
              ...
              return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a2) {
                  switch (_a2.label) {
                    ...
                    case 1:
                      _a2.trys.push([1, 3, , 4]);
                      return [4, instantiateAsync(wasmBinary, wasmBinaryFile, info)];
                    case 2:
                      result = _a2.sent();
                      exports2 = receiveInstantiationResult(result);
                      return [2, exports2];
                    case 3:
                      e_1 = _a2.sent();
            ...
            return __generator(this, function(_a2) {
              switch (_a2.label) {
                case 0:
                    ...
                    readAsync = function(filename_1) {
                      ...
                      return __awaiter(_this, __spreadArray([filename_1], args_1, true), void 0, function(filename, binary) {
                        ...
                        return __generator(this, function(_a3) {
                          filename = isFileURI(filename) ? new URL(filename) : filename;
                          ret = fs.readFileSync(filename, binary ? void 0 : "utf8");
                          return [2, ret];
                        });
                      });
                    };
                          ...
                          return __generator(this, function(_a3) {
                            switch (_a3.label) {
                              case 0:
                                ...
                                return [4, fetch(url, { credentials: "same-origin" })];
                              case 1:
                                response = _a3.sent();
                                if (response.ok) {
                  ...
                  intArrayFromString = function(stringy, dontAddNull, length) {
                  ...
                  TTY = { ttys: [], init: function() {
                    ...
                    var _a3;
                    if (((_a3 = tty.output) === null || _a3 === void 0 ? void 0 : _a3.length) > 0) {
                      out(UTF8ArrayToString(tty.output));
                      tty.output = [];
                    }
                  ...
                  MEMFS = { ops_table: null, mount: function(mount) {
                    ...
                    for (var _i = 0, _a3 = ["mode", "atime", "mtime", "ctime"]; _i < _a3.length; _i++) {
                      var key = _a3[_i];
                      if (attr[key] != null) {
                        node[key] = attr[key];
                      }
                    ...
                    return __spreadArray([".", ".."], Object.keys(node.contents), true);
                  ...
                  FS_createDataFile = function(parent, name, fileData, canRead, canWrite, canOwn) {
                  ...
                  FS = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, filesystems: null, syncFSRequests: 0, readFiles: {}, ErrnoError: (
                    /** @class */
                    /* @__PURE__ */ (function() {
                    ...
                    (_a3 = opts.follow_mount) !== null && _a3 !== void 0 ? _a3 : opts.follow_mount = true;
                    if (!PATH.isAbs(path)) {
                      path = FS.cwd() + "/" + path;
                    }
                  ...
                  }, checkOpExists: function(op, err2) {
                    if (!op) {
                    ...
                    FS.streams[fd] = null;
                  }, dupStream: function(origStream, fd) {
                    var _a3, _b;
                    if (fd === void 0) {
                      fd = -1;
                    }
                    var stream = FS.createStream(origStream, fd);
                    (_b = (_a3 = stream.stream_ops) === null || _a3 === void 0 ? void 0 : _a3.dup) === null || _b === void 0 ? void 0 : _b.call(_a3, stream);
                    return stream;
                    ...
                    (_b = (_a3 = stream.stream_ops).open) === null || _b === void 0 ? void 0 : _b.call(_a3, stream);
                  }, llseek: function() {
                  ...
                  }, statfsStream: function(stream) {
                    return FS.statfsNode(stream.node);
                  }, statfsNode: function(node) {
                  ...
                  }, doChmod: function(stream, node, mode, dontFollow) {
                  ...
                  }, doChown: function(stream, node, dontFollow) {
                  ...
                  }, doTruncate: function(stream, node, len) {
                    if (FS.isDir(node.mode)) {
                    ...
                    FS.mount({ mount: function() {
                      ...
                      node.node_ops = { lookup: function(parent, name) {
                        ...
                        return Array.from(FS.streams.entries()).filter(function(_a3) {
                          var k = _a3[0], v = _a3[1];
                          return v;
                        }).map(function(_a3) {
                          var k = _a3[0], v = _a3[1];
                  ...
                  }, createStandardStreams: function(input, output, error) {
                    if (input) {
                    ...
                    for (var _i = 0, _a3 = FS.streams; _i < _a3.length; _i++) {
                      var stream = _a3[_i];
                      if (stream) {
                        FS.close(stream);
                      }
                    ...
                    (_a3 = (_b = FS.createDevice).major) !== null && _a3 !== void 0 ? _a3 : _b.major = 64;
                    var dev = FS.makedev(FS.createDevice.major++, 0);
                    FS.registerDevice(dev, { open: function(stream) {
                      stream.seekable = false;
                    }, close: function(stream) {
                      var _a4;
                      if ((_a4 = output === null || output === void 0 ? void 0 : output.buffer) === null || _a4 === void 0 ? void 0 : _a4.length) {
                        output(10);
                      }
                    }, read: function(stream, buffer, offset, length, pos) {
                      var bytesRead = 0;
                    ...
                    var LazyUint8Array = (
                      ...
                      (function() {
                        ...
                        LazyUint8Array2.prototype.get = function(idx) {
                        ...
                        LazyUint8Array2.prototype.setDataGetter = function(getter) {
                          this.getter = getter;
                        };
                        LazyUint8Array2.prototype.cacheLength = function() {
                          var xhr = new XMLHttpRequest();
                        ...
                        Object.defineProperty(LazyUint8Array2.prototype, "length", {
                          get: function() {
                            if (!this.lengthKnown) {
                              this.cacheLength();
                            }
                        ...
                        Object.defineProperty(LazyUint8Array2.prototype, "chunkSize", {
                          get: function() {
                            if (!this.lengthKnown) {
                              this.cacheLength();
                            }
                  ...
                  SYSCALLS = { DEFAULT_POLLMASK: 5, calculateAt: function(dirfd, path, allowEmpty) {
                    ...
                    return 0;
                  }, writeStatFs: function(buf, stats) {
                    ...
                    var stream = FS.getStreamChecked(fd);
                    return stream;
                  }, varargs: void 0, getStr: function(ptr) {
                  ...
                  PIPEFS = { BUCKET_BUFFER_SIZE: 8192, mount: function(mount) {
                  ...
                  }, stream_ops: { getattr: function(stream) {
                    var node = stream.node;
                    ...
                    for (var _i = 0, _a3 = pipe.buckets; _i < _a3.length; _i++) {
                      var bucket = _a3[_i];
                    ...
                    var toRemove = 0;
                    for (var _b = 0, _c = pipe.buckets; _b < _c.length; _b++) {
                      var bucket = _c[_b];
                  ...
                  __tzset_js = function(timezone, daylight, std_name, dst_name) {
                  ...
                  _environ_get = function(__environ, environ_buf) {
                    var bufSize = 0;
                  ...
                  _environ_sizes_get = function(penviron_count, penviron_buf_size) {
                  ...
                  _proc_exit = function(code) {
                    var _a3;
                    EXITSTATUS = code;
                    if (!keepRuntimeAlive()) {
                      (_a3 = Module["onExit"]) === null || _a3 === void 0 ? void 0 : _a3.call(Module, code);
                      ABORT = true;
                    }
  ...
  // node_modules/libarchive-wasm/dist/wrapLibarchiveWasm.js
  var require_wrapLibarchiveWasm = __commonJS({
    "node_modules/libarchive-wasm/dist/wrapLibarchiveWasm.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.wrapLibarchiveWasm = wrapLibarchiveWasm;
      function wrapLibarchiveWasm(module2) {
        ...
        var nonzero = function(r) {
          return r !== 0;
        };
        return {
          module: module2,
          version_number: module2.cwrap("archive_version_number", "number", []),
          version_string: module2.cwrap("archive_version_string", "string", []),
          version_details: module2.cwrap("archive_version_details", "string", []),
          read_new_memory: checkReturnValue(module2.cwrap("archive_read_new_memory", "number", [
            "number",
            "number",
            "string"
          ]), function(r) {
          ...
          read_new: module2.cwrap("archive_read_new", "number", []),
          read_support_filter_all: checkReturnValue(module2.cwrap("archive_read_support_filter_all", "number", ["number"]), nonzero),
          read_support_format_all: checkReturnValue(module2.cwrap("archive_read_support_format_all", "number", ["number"]), nonzero),
          read_open_memory: checkReturnValue(module2.cwrap("archive_read_open_memory", "number", ["number", "number", "number"]), nonzero),
          read_next_entry: module2.cwrap("archive_read_next_entry", "number", ["number"]),
          read_has_encrypted_entries: module2.cwrap("archive_read_has_encrypted_entries", "number", [
            "number"
          ]),
          read_data: checkReturnValue(module2.cwrap("archive_read_data", "number", ["number", "number", "number"]), function(r) {
            return r < 0;
          }),
          read_data_skip: checkReturnValue(module2.cwrap("archive_read_data_skip", "number", ["number"]), nonzero),
          read_add_passphrase: checkReturnValue(module2.cwrap("archive_read_add_passphrase", "number", ["number", "string"]), nonzero),
          read_free: checkReturnValue(module2.cwrap("archive_read_free", "number", ["number"]), nonzero),
          error_string: module2.cwrap("archive_error_string", "string", ["number"]),
          entry_filetype: module2.cwrap("archive_entry_filetype", "number", ["number"]),
          entry_pathname: module2.cwrap("archive_entry_pathname_utf8", "string", ["number"]),
          entry_symlink: module2.cwrap("archive_entry_symlink_utf8", "string", ["number"]),
          entry_hardlink: module2.cwrap("archive_entry_hardlink_utf8", "string", ["number"]),
          entry_size: module2.cwrap("archive_entry_size", "number", ["number"]),
          entry_atime: module2.cwrap("archive_entry_atime", "number", ["number"]),
          entry_birthtime: module2.cwrap("archive_entry_birthtime", "number", ["number"]),
          entry_ctime: module2.cwrap("archive_entry_ctime", "number", ["number"]),
          entry_mtime: module2.cwrap("archive_entry_mtime", "number", ["number"]),
          entry_is_encrypted: module2.cwrap("archive_entry_is_encrypted", "number", ["number"])
        };
      }
    }
  });

  // node_modules/libarchive-wasm/dist/libarchiveWasm.js
  var require_libarchiveWasm = __commonJS({
    "node_modules/libarchive-wasm/dist/libarchiveWasm.js"(exports) {
      "use strict";
      var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
        function adopt(value) {
          return value instanceof P ? value : new P(function(resolve) {
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.libarchiveWasm = libarchiveWasm2;
      var libarchive_1 = __importDefault(require_libarchive());
      var wrapLibarchiveWasm_1 = require_wrapLibarchiveWasm();
      function libarchiveWasm2() {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
          args[_i] = arguments[_i];
        }
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a) {
            return [2, libarchive_1.default.apply(void 0, args).then(function(mod) {
              return (0, wrapLibarchiveWasm_1.wrapLibarchiveWasm)(mod);
            })];
          });
        });
      }
  ...
  // node_modules/libarchive-wasm/dist/index.js
  var require_dist = __commonJS({
    "node_modules/libarchive-wasm/dist/index.js"(exports) {
      "use strict";
      ...
      __exportStar(require_ArchiveReader(), exports);
      var libarchive_1 = require_libarchive();
      Object.defineProperty(exports, "libarchive", { enumerable: true, get: function() {
        return __importDefault(libarchive_1).default;
      } });
      __exportStar(require_libarchiveWasm(), exports);
      __exportStar(require_wrapLibarchiveWasm(), exports);
    }
  });

  // browser-entry.js
  var { libarchiveWasm } = require_dist();
  var { ArchiveReader } = require_ArchiveReader();
  var { ArchiveReaderEntry } = require_ArchiveReaderEntry();
  window.libarchiveWasm = libarchiveWasm;
  window.ArchiveReader = ArchiveReader;
  window.ArchiveReaderEntry = ArchiveReaderEntry;
})();
